    ...
    <div className="form">
      <div className="form-body">
        ...
        <div className="lastname">
          ...
          <input type="text" id="lastName" className="form__input" placeholder="Last Name" value={lastName} onChange={(e) => setLastName(e.target.value)} />
        </div>
        <div className="email">
        ...
        <div className="phone-number">
          ...
          <input type="tel" id="phoneNumber" className="form__input" placeholder="Phone Number" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} pattern="[0-9]{10}" required />
        </div>
